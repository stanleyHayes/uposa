...
// Member handlers
export async function listPollsHandler(req: RouteRequest, res: Response): Promise<void> {
...
export async function getPollByIdHandler(req: RouteRequest, res: Response): Promise<void> {
...
// Admin handlers
export async function createPollHandler(req: RouteRequest, res: Response): Promise<void> {
...
export async function closePollHandler(req: RouteRequest, res: Response): Promise<void> {
  const { id } = req.params;
  const poll = await closePoll(id);
  successResponse(res, 'Poll closed', poll);
}

export async function adminListAllPollsHandler(req: RouteRequest, res: Response): Promise<void> {
...
export async function adminUpdatePollHandler(req: RouteRequest, res: Response): Promise<void> {
  const { id } = req.params;
...
export async function adminDeletePollHandler(req: RouteRequest, res: Response): Promise<void> {
  const { id } = req.params;
  const result = await adminDeletePoll(id);
  successResponse(res, result.message);
}

export async function adminGetPollResultsHandler(req: RouteRequest, res: Response): Promise<void> {
  const { id } = req.params;
