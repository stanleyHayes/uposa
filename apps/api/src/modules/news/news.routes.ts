...
router.post('/admin', adminMiddleware, uploadLimiter, uploadSingle('image'), createNewsHandler);
router.put('/admin/:id', adminMiddleware, uploadLimiter, uploadSingle('image'), updateNewsHandler);
