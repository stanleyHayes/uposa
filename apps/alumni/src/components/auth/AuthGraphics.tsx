  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        fill="#001B50" fillOpacity="0.12"
        initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
        transition={{ duration: 1, delay: 0.3 }}
      />
      <motion.path
        d="M140 60 L40 110 L140 160 L240 110 Z"
        stroke="#001B50" strokeWidth="2" fill="none" strokeOpacity="0.6"
        initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
      ...
      >
        <line x1="200" y1="88" x2="230" y2="130" stroke="#D4AF37" strokeWidth="2.5" strokeLinecap="round" />
        <circle cx="232" cy="134" r="6" fill="#D4AF37" />
        <motion.g
          animate={{ y: [0, -5, 0] }}
          transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
        >
          <line x1="230" y1="134" x2="230" y2="160" stroke="#D4AF37" strokeWidth="2" strokeLinecap="round" />
        </motion.g>
      </motion.g>
      {/* Podium */}
      <motion.path
        d="M90 160 L90 200 L190 200 L190 160"
        stroke="#001B50" strokeOpacity="0.25" strokeWidth="1.5" fill="none"
        initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
      ...
      <motion.path
        ...
        stroke="#001B50" strokeOpacity="0.12" strokeWidth="1" fill="none" strokeDasharray="4 4"
        initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
